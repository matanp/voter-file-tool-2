...
1. **Start with** [0.1 Backend enforcement](0.1-backend-enforcement-already-in-committee.md) — no dependencies, closes correctness gap
2. **Then** [1.1 Committee Term Model](1.1-committee-term-model.md) — critical foundation
3. **In parallel:** [T1.1 handleRequest route tests](T1.1-handleRequest-route-tests.md) — testing can run alongside Phase 1
...
|----|-------|--------|---------|
| [0.1](0.1-backend-enforcement-already-in-committee.md) | Backend enforcement for "Already in Another Committee" | Open | Tier 0 §0.1 |
| [1.1](1.1-committee-term-model.md) | Committee Term Model | Open | Tier 1 §1.1 |
