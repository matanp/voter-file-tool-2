...
| Data lifecycle & retention | [WHOLE_APP_DATA_LIFECYCLE_RETENTION_REVIEW_METHODOLOGY.md](./WHOLE_APP_DATA_LIFECYCLE_RETENTION_REVIEW_METHODOLOGY.md) | `WHOLE_APP_DATA_LIFECYCLE_RETENTION_REVIEW_*` |
| Frontend state & interaction correctness | [WHOLE_APP_FRONTEND_STATE_INTERACTION_REVIEW_METHODOLOGY.md](./WHOLE_APP_FRONTEND_STATE_INTERACTION_REVIEW_METHODOLOGY.md) | `WHOLE_APP_FRONTEND_STATE_INTERACTION_REVIEW_*` |
| Accessibility & mobile operability | [WHOLE_APP_ACCESSIBILITY_MOBILE_REVIEW_METHODOLOGY.md](./WHOLE_APP_ACCESSIBILITY_MOBILE_REVIEW_METHODOLOGY.md) | `WHOLE_APP_ACCESSIBILITY_MOBILE_REVIEW_*` |
| Dev experience & local reproducibility | [WHOLE_APP_DEV_EXPERIENCE_REPRODUCIBILITY_REVIEW_METHODOLOGY.md](./WHOLE_APP_DEV_EXPERIENCE_REPRODUCIBILITY_REVIEW_METHODOLOGY.md) | `WHOLE_APP_DEV_EXPERIENCE_REPRODUCIBILITY_REVIEW_*` |

Completed review deliverables remain under `docs/` (e.g. `docs/WHOLE_APP_ARCHITECTURE_REVIEW_<model>_YYYY-MM-DD.md`).

Future improvements and candidate vectors are tracked in
