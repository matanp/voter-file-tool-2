...
import { CommitteeRosterReportForm } from "./CommitteeRosterReportForm";
  ...
  return (
    <div className="w-full min-h-screen bg-primary-foreground">
      <div className="max-w-6xl mx-auto p-4">
        <div className="mb-6">
          <h1 className="primary-header">Committee Roster Reports</h1>
          <p className="text-muted-foreground mt-2">
            Generate a current committee roster for your jurisdiction (leaders)
            or countywide/jurisdiction scope (admins).
          </p>
        </div>
