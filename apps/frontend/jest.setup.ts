...
jest.mock("@prisma/client", () => {
  ...
  return {
    ...
    AuditAction: {
      ...
      GOVERNANCE_CONFIG_UPDATED: "GOVERNANCE_CONFIG_UPDATED",
      ...
      DISCREPANCY_ACCEPTED: "DISCREPANCY_ACCEPTED",
      DISCREPANCY_REJECTED: "DISCREPANCY_REJECTED",
      DISCREPANCY_UNDONE: "DISCREPANCY_UNDONE",
      CROSSWALK_IMPORTED: "CROSSWALK_IMPORTED",
      OFFICE_NAMES_BULK_CREATED: "OFFICE_NAMES_BULK_CREATED",
      ELECTION_DATES_BULK_CREATED: "ELECTION_DATES_BULK_CREATED",
      OFFICE_NAME_CREATED: "OFFICE_NAME_CREATED",
      OFFICE_NAME_DELETED: "OFFICE_NAME_DELETED",
      ELECTION_DATE_CREATED: "ELECTION_DATE_CREATED",
      ELECTION_DATE_DELETED: "ELECTION_DATE_DELETED",
    },
    DiscrepancyResolution: {
      ACCEPTED: "ACCEPTED",
      ACCEPTED_WITH_ADDRESS: "ACCEPTED_WITH_ADDRESS",
      REJECTED: "REJECTED",
    },
    Prisma: {
      ...actual.Prisma,
