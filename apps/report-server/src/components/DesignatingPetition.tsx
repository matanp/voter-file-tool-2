...
const PetitionForm = React.forwardRef<HTMLDivElement>((_, ref) => {
  ...
  const witnessStatement = `____________________ state: I am a duly qualified voter of the State of New York and am an enrolled voter of the ____________________ Party.`;
  ...
  return (
    ...
    >
      ...
      <div className="border border-black h-16 mt-1"></div>
      ...
      <table className="w-full mt-1 text-xs border-2 border-black">
        <thead>
          <tr className="border-b-2 border-black text-left align-top">
            <th className="border border-black w-[12%] pl-2 font-bold">Date</th>
            ...
            .map((_, i) => (
              <React.Fragment key={i}>
                <tr className={i % 2 === 1 ? 'border-t-2 border-black' : ''}>
                  ...
                  <td className="border border-black h-16 p-1" rowSpan={2}></td>
                  <td
